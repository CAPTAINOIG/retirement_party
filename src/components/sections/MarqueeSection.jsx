...
const Separator = () => (
  <span className="mx-6 text-gold-700 opacity-50 select-none">◆</span>
);
...
const Item = ({ before, after }) => (
  <span className="inline-flex items-baseline gap-3 whitespace-nowrap">
    ...
    <span className="text-gold-500 opacity-40 text-sm">→</span>
...
const MarqueeSection = () => {
  ...
  return (
    <div className="relative py-7 bg-dark-800 border-y border-gold-500/10 overflow-hidden">
