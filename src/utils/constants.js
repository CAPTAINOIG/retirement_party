...
export const HEAR_ABOUT_OPTIONS = [
  ...
  { value: 'techcabal', label: 'TechCabal / Techpoint' },
  { value: 'social', label: 'Instagram / Twitter' },
  { value: 'other', label: 'Other' }
]

export const PARTICLES = [
  { left: "8%",  top: "15%", delay: 0 },   { left: "22%", top: "72%", delay: 0.8 },
  { left: "38%", top: "28%", delay: 0.4 }, { left: "54%", top: "85%", delay: 1.2 },
  { left: "67%", top: "12%", delay: 0.6 }, { left: "78%", top: "60%", delay: 0.2 },
  { left: "90%", top: "40%", delay: 1.0 }, { left: "14%", top: "50%", delay: 1.6 },
  { left: "48%", top: "55%", delay: 0.9 }, { left: "82%", top: "22%", delay: 0.3 },
  { left: "31%", top: "90%", delay: 1.4 }, { left: "72%", top: "78%", delay: 0.7 },
];
